...
export function ServiceCard({
  ...
  return (
    <div
      className={`
        relative p-8 rounded-2xl shadow-lg transition-all duration-500 hover:shadow-2xl group h-70 flex flex-col justify-between 
    ...
    >
      ...
      <div>
        ...
        <div className="absolute inset-0 rounded-2xl">
          <div
            className="
          w-40 h-30 rounded-2xl flex items-center justify-center text-white shadow-lg
          transition-all duration-500 md:group-hover:scale-115 md:group-hover:-rotate-3 -rotate-3 md:group-hover:translate-x-25 translate-x-15 -translate-y-2 border-8 border-gray-50"
          >
            <img
              src={imgUrl}
              alt="Pattern"
